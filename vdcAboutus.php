    ...
    <div class=" Principal_Details">
        ...
        <div class="principal" id="chairman-msg">
            ...
            <div class="Practice_img">
                <img src="./images/about/knImage.jpeg" alt="">
            </div>
        </div>
        ...
        <div class="principal principal2" id="correspondent-msg">
            ...
            <div class="Principal_info">
                <div>
                    ...
                    <p>Smt. Lavanya Naresh, (Director), always articulate that our present Education System isn't worth
                        a great deal if it teaches Young People how
                        to make a Living but doesn's teach them how to make a Life... System is increasingly embracing a
                        Black- and-White way of thinking, in which
                        Learning and Play are DIAMETRICALLY OPPOSED. So, the true purpose of Education is to make Minds,
                        not Careers...
                        President Vivekananda Degree & P.G. College throw in the Powerfull Weapons which are used to
            ...
            <div class="Practice_img">
                <img src="./images/about/knwifeimage.jpeg" alt="">
            </div>
